...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Navigate"] = $PS["Navigate"] || {};
  var exports = $PS["Navigate"];
  var Control_Monad_Trans_Class = $PS["Control.Monad.Trans.Class"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];                
  var Nav = function (Monad0, navigate) {
      this.Monad0 = Monad0;
  ...
  var navHalogenM = function (dictNav) {
      return new Nav(function () {
          ...
          var $1 = Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictNav.Monad0());
          var $2 = navigate(dictNav);
          return function ($3) {
              return $1($2($3));
          };
      })());
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["RouteItems"] = $PS["RouteItems"] || {};
  var exports = $PS["RouteItems"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Generic_Rep = $PS["Data.Generic.Rep"];
  var Data_Semigroup = $PS["Data.Semigroup"];
  var Data_Show = $PS["Data.Show"];
  ...
  var NoAct = (function () {
      ...
      NoAct.value = new NoAct();
      return NoAct;
  })();
  var showRoute = new Data_Show.Show(function (r) {
      if (r instanceof Home) {
          return "the home route";
      };
      if (r instanceof New) {
          return "the new route";
      };
      if (r instanceof Edit) {
          return "the edit route" + r.value0;
      };
      throw new Error("Failed pattern match at RouteItems (line 23, column 12 - line 26, column 38): " + [ r.constructor.name ]);
  });
  var genericRoute = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at RouteItems (line 18, column 1 - line 18, column 48): " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var routeCodec = Routing_Duplex.root(Routing_Duplex_Generic.sum(genericRoute)(Routing_Duplex_Generic.gRouteSum(Routing_Duplex_Generic.gRouteConstructor(new Data_Symbol.IsSymbol(function () {
      ...
      Home: Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteNoArguments))("contacts")(Routing_Duplex_Generic.noArgs),
      New: Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteNoArguments))("contacts")(Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteNoArguments))("new")(Routing_Duplex_Generic.noArgs)),
      Edit: Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteAll))("contacts")(Routing_Duplex.string(Routing_Duplex.segment))
  }));
  var safeHref = (function () {
      var $28 = Data_Semigroup.append(Data_Semigroup.semigroupString)("#");
      var $29 = Routing_Duplex.print(routeCodec);
      return function ($30) {
          return Halogen_HTML_Properties.href($28($29($30)));
      };
  })();
...
(function($PS) {
  ...
  var Effect_Aff_Class = $PS["Effect.Aff.Class"];
  var Effect_Class = $PS["Effect.Class"];
  var Navigate = $PS["Navigate"];
  var RouteItems = $PS["RouteItems"];
  var Routing_Duplex = $PS["Routing.Duplex"];
  ...
  var navAppM = new Navigate.Nav(function () {
      return monadAppM;
  }, (function () {
      var $3 = Effect_Class.liftEffect(monadEffectAppM);
      var $4 = Routing_Duplex.print(RouteItems.routeCodec);
      return function ($5) {
...
(function($PS) {
  ...
  var Data_Symbol = $PS["Data.Symbol"];
  var Effect_Aff = $PS["Effect.Aff"];
  var contactsFromJson = function (j) {
      return Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "phone";
  ...
  var findAll = Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)("http://localhost:9000/contacts"))(function (items) {
      return Control_Applicative.pure(Effect_Aff.applicativeAff)((function () {
          if (items instanceof Data_Either.Left) {
              return Data_Either.Left.create(Affjax.printError(items.value0));
          };
          if (items instanceof Data_Either.Right) {
              var v = contactsFromJson(items.value0.body);
              if (v instanceof Data_Either.Left) {
                  return new Data_Either.Left("Bad Serialization");
              };
              if (v instanceof Data_Either.Right) {
                  return new Data_Either.Right(v.value0);
              };
              throw new Error("Failed pattern match at Repo (line 27, column 7 - line 29, column 27): " + [ v.constructor.name ]);
          };
          throw new Error("Failed pattern match at Repo (line 24, column 10 - line 29, column 27): " + [ items.constructor.name ]);
      })());
  });
  var contactFromJson = function (j) {
      return Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
          return "phone";
      }))()())(new Data_Symbol.IsSymbol(function () {
          return "name";
      }))()())(new Data_Symbol.IsSymbol(function () {
  ...
  var findById = function (id) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)("http://localhost:9000/contacts/" + id))(function (item) {
          return Control_Applicative.pure(Effect_Aff.applicativeAff)((function () {
              if (item instanceof Data_Either.Left) {
                  return Data_Either.Left.create(Affjax.printError(item.value0));
              };
              if (item instanceof Data_Either.Right) {
                  var v = contactFromJson(item.value0.body);
                  if (v instanceof Data_Either.Left) {
                      return new Data_Either.Left("Bad Serialization");
                  };
                  if (v instanceof Data_Either.Right) {
                      return Data_Either.Right.create(new Data_Maybe.Just(v.value0));
                  };
                  throw new Error("Failed pattern match at Repo (line 38, column 7 - line 40, column 34): " + [ v.constructor.name ]);
              };
              throw new Error("Failed pattern match at Repo (line 35, column 10 - line 40, column 34): " + [ item.constructor.name ]);
          })());
      });
  };
...
(function($PS) {
  ...
  var renderRow = function (c) {
      return Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(c.name) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(c.email) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(c.phone) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Elements.a([ RouteItems.safeHref(RouteItems.New.value) ])([ Halogen_HTML_Core.text("View") ]) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Elements.a([ RouteItems.safeHref(RouteItems.Edit.create(c.id)) ])([ Halogen_HTML_Core.text("Editt") ]) ]) ]);
  };
  var initialContactTableState = function (v) {
      return {
          contacts: [  ]
      };
  };
  var contactTableComponent = function (dictMonadAff) {
      var render = function (state) {
          return Halogen_HTML_Elements.table_([ Halogen_HTML_Elements.thead_([ Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Name") ]), Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Email") ]), Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Phone") ]), Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("View") ]), Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Edit") ]) ]) ]), Halogen_HTML_Elements.tbody_(Data_Functor.map(Data_Functor.functorArray)(renderRow)(state.contacts)) ]);
      };
      var handle = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Repo.findAll))(function (contactsEither) {
              if (contactsEither instanceof Data_Either.Left) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      return st;
                  });
              };
              if (contactsEither instanceof Data_Either.Right) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      var $8 = {};
                      for (var $9 in st) {
                      ...
                      $8.contacts = contactsEither.value0;
                      return $8;
                  });
              };
              throw new Error("Failed pattern match at Components (line 56, column 11 - line 58, column 61): " + [ contactsEither.constructor.name ]);
          });
      };
      return Halogen_Component.mkComponent({
          ...
          "eval": Halogen_Component.mkEval({
              ...
              initialize: new Data_Maybe.Just(NoAction.value),
...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Comps.Edit"] = $PS["Comps.Edit"] || {};
  var exports = $PS["Comps.Edit"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var DOM_HTML_Indexed_InputType = $PS["DOM.HTML.Indexed.InputType"];
  var Data_Either = $PS["Data.Either"];
  ...
  var Repo = $PS["Repo"];                
  var NoAction = (function () {
      function NoAction(value0) {
          this.value0 = value0;
      };
      NoAction.create = function (value0) {
          return new NoAction(value0);
      };
      return NoAction;
  })();
  var itemOrEmpty = function (item) {
      return function (func) {
          return Data_Maybe.fromMaybe("")(Data_Functor.map(Data_Maybe.functorMaybe)(func)(item));
      };
  };
  var render = function (dictMonadAff) {
      return function (state) {
          return Halogen_HTML_Elements.form_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Name") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.name("name"), Halogen_HTML_Properties.value(itemOrEmpty(state.maybeContact)(function (v) {
              return v.name;
          })) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Email") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.name("email"), Halogen_HTML_Properties.value(itemOrEmpty(state.maybeContact)(function (v) {
              return v.email;
          })) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Phone Number") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.name("phone"), Halogen_HTML_Properties.value(itemOrEmpty(state.maybeContact)(function (v) {
              return v.phone;
          })) ]), Halogen_HTML_Elements.br_, Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputSubmit.value) ]) ]);
      };
  };
  var initialState = function (id) {
      return {
          maybeContact: Data_Maybe.Nothing.value,
          id: id
      };
  };
  var handleAction = function (dictMonadAff) {
      return function (action) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Repo.findById(action.value0)))(function (res) {
              ...
              if (res instanceof Data_Either.Right) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      ...
                      $12.maybeContact = res.value0;
                      return $12;
                  });
              };
              throw new Error("Failed pattern match at Comps.Edit (line 66, column 7 - line 69, column 49): " + [ res.constructor.name ]);
          });
      };
  };
  var componentEdit = function (dictMonadAff) {
      return function (id) {
          return Halogen_Component.mkComponent({
              ...
              "eval": Halogen_Component.mkEval({
                  ...
                  handleQuery: Halogen_Component.defaultEval.handleQuery,
                  receive: Halogen_Component.defaultEval.receive,
                  initialize: Data_Maybe.Just.create(new NoAction(id)),
                  finalize: Halogen_Component.defaultEval.finalize
              })
          });
      };
  };
  exports["componentEdit"] = componentEdit;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
      ...
      return function (dictNav) {
          var render = function (v) {
              if (v.route instanceof Data_Maybe.Just) {
                  if (v.route.value0 instanceof RouteItems.Home) {
                      return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                          return "home";
                      }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Components.contactTableComponent(dictMonadAff))({})(Data_Void.absurd);
                  };
                  if (v.route.value0 instanceof RouteItems.New) {
                      return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("New Contact") ]);
                  };
                  if (v.route.value0 instanceof RouteItems.Edit) {
                      return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
                          return "edit";
                      }))(Data_Ord.ordUnit)(Data_Symbol.SProxy.value)(Data_Unit.unit)(Comps_Edit.componentEdit(dictMonadAff)(v.route.value0.value0))({})(Data_Void.absurd);
                  };
                  throw new Error("Failed pattern match at Routes (line 114, column 11 - line 122, column 94): " + [ v.route.value0.constructor.name ]);
              };
              if (v.route instanceof Data_Maybe.Nothing) {
                  return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Not Found!") ]);
              };
              throw new Error("Failed pattern match at Routes (line 112, column 7 - line 125, column 41): " + [ v.route.constructor.name ]);
          };
          var handleQuery = function (v) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Data_Maybe.eqMaybe(RouteItems.eqRoute))(v1.route)(new Data_Maybe.Just(v.value0)))(Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Class_Console.log(Effect_Class.monadEffectEffect)("in handle query " + Data_Show.show(RouteItems.showRoute)(v.value0))))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          var $20 = {};
                          for (var $21 in st) {
                          ...
                          $20.route = new Data_Maybe.Just(v.value0);
                          return $20;
                      });
                  })))(function () {
          ...
          var handleAction = function (v) {
              if (v instanceof RouteItems.Init) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Routing_Hash.getHash))(function (hash) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)((dictMonadAff.MonadEffect0()).Monad0())(Effect_Class_Console.log(dictMonadAff.MonadEffect0())(Data_Show.show(Data_Show.showString)(hash))))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)((function () {
                              var $35 = Routing_Duplex.parse(RouteItems.routeCodec);
                              return function ($36) {
                                  return Data_Either.hush($35($36));
                              };
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)((dictMonadAff.MonadEffect0()).Monad0())(Effect_Class_Console.log(dictMonadAff.MonadEffect0())(Data_Show.show(Data_Maybe.showMaybe(RouteItems.showRoute))(initialRoute))))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Navigate_1.navigate(Navigate_1.navHalogenM(dictNav))(Data_Maybe.fromMaybe(RouteItems.Home.value)(initialRoute)))(function () {
                                      var route = Data_Maybe.fromMaybe(RouteItems.Home.value)(initialRoute);
                                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                          var $27 = {};
                                          for (var $28 in st) {
                                          ...
                                          $27.route = new Data_Maybe.Just(route);
                                          return $27;
                                      });
                                  });
                              });
              ...
              if (v instanceof RouteItems.Rec) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      return st;
                  });
              };
              if (v instanceof RouteItems.ShowEdit) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Class_Console.log(Effect_Class.monadEffectEffect)("edit shown")))(function () {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                          var $30 = {};
                          for (var $31 in st) {
                          ...
                          $30.route = Data_Maybe.Just.create(new RouteItems.Edit("1"));
                          return $30;
                      });
                  });
              };
              if (v instanceof RouteItems.GoTo) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Class_Console.log(Effect_Class.monadEffectEffect)("go to " + Data_Show.show(RouteItems.showRoute)(v.value0))))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_MouseEvent.toEvent(v.value1))))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                              ...
                              return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Data_Maybe.eqMaybe(RouteItems.eqRoute))(mRoute)(new Data_Maybe.Just(v.value0)))(Navigate_1.navigate(Navigate_1.navHalogenM(dictNav))(v.value0));
                          });
                      });
                  });
              };
              if (v instanceof RouteItems.NoAct) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      return st;
                  });
              };
              throw new Error("Failed pattern match at Routes (line 80, column 20 - line 107, column 30): " + [ v.constructor.name ]);
          };
          return Halogen_Component.mkComponent({
              initialState: function (v) {
                  return initialState;
              ...
              "eval": Halogen_Component.mkEval({
                  ...
                  receive: Halogen_Component.defaultEval.receive,
                  initialize: new Data_Maybe.Just(RouteItems.Init.value),
                  finalize: Halogen_Component.defaultEval.finalize
              })
          });
      };
...
(function($PS) {
  ...
  var render = function (state) {
      ...
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.ul_(Data_Functor.map(Data_Functor.functorArray)(function (i) {
          return Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text(i) ]);
      })(state.items)), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.title(label), Halogen_HTML_Events.onClick(function (v) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      var env = {};
      var rootComponent = Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Effect_Aff.functorAff)(AppM.runAppM(env))(Routes.component(AppM.monadAffAppM)(AppM.navAppM));
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(rootComponent)({})(body))(function (halogenIO) {
          return Data_Functor["void"](Effect_Aff.functorAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Routing_Hash.matchesWith(Data_Either.foldableEither)(Routing_Duplex.parse(RouteItems.routeCodec))(function (old) {
              return function ($$new) {
                  return function __do() {
                      Effect_Console.log("new : " + Data_Show.show(RouteItems.showRoute)($$new))();
                      Effect_Console.log("old : " + Data_Show.show(Data_Maybe.showMaybe(RouteItems.showRoute))(old))();
                      return Control_Applicative.when(Effect.applicativeEffect)(Data_Eq.notEq(Data_Maybe.eqMaybe(RouteItems.eqRoute))(old)(new Data_Maybe.Just($$new)))(Effect_Aff.launchAff_(halogenIO.query(Halogen_Query.tell(Routes.Navigate.create($$new)))))();
                  };
              };
          })));
      });
  ...
  var handleAction = function (v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Repo.findAll))(function (itemsEither) {
          if (itemsEither instanceof Data_Either.Left) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var $9 = {};
                  for (var $10 in st) {
                  ...
                  $9.items = [ itemsEither.value0 ];
                  return $9;
              });
          };
          if (itemsEither instanceof Data_Either.Right) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  var $13 = {};
                  for (var $14 in st) {
                  ...
                  $13.enabled = !st.enabled;
                  $13.items = Data_Functor.map(Data_Functor.functorArray)(function (item) {
                      return item.name;
                  })(itemsEither.value0);
                  return $13;
              });
          };
          throw new Error("Failed pattern match at Main (line 66, column 5 - line 68, column 103): " + [ itemsEither.constructor.name ]);
      });
  };
  var autoLog = function (dictShow) {
      return function (i) {
