  ...
  var findAll = Control_Bind.bind(Effect_Aff.bindAff)(Affjax.get(Affjax_ResponseFormat.json)("http://localhost:9000/contacts"))(function (items) {
      return Control_Applicative.pure(Effect_Aff.applicativeAff)((function () {
          ...
          if (items instanceof Data_Either.Right) {
              ...
              throw new Error("Failed pattern match at Repo (line 25, column 7 - line 27, column 27): " + [ v.constructor.name ]);
          };
          throw new Error("Failed pattern match at Repo (line 22, column 10 - line 27, column 27): " + [ items.constructor.name ]);
      })());
  });
          ...
          var render = function (v) {
              if (v.route instanceof Data_Maybe.Just) {
                  ...
                  if (v.route.value0 instanceof RouteItems.Edit) {
                      return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Edit Contact") ]);
                  };
                  throw new Error("Failed pattern match at Routes (line 114, column 11 - line 122, column 47): " + [ v.route.value0.constructor.name ]);
              };
              if (v.route instanceof Data_Maybe.Nothing) {
                  return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Not Found!") ]);
              };
              throw new Error("Failed pattern match at Routes (line 112, column 7 - line 124, column 41): " + [ v.route.constructor.name ]);
          };
