...
(function($PS) {
  ...
  var renderRow = function (c) {
      return Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(c.name) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(c.email) ]), Halogen_HTML_Elements.td_([ Halogen_HTML_Core.text(c.phone) ]) ]);
  };
  ...
  var contactTableComponent = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.table_([ Halogen_HTML_Elements.thead_([ Halogen_HTML_Elements.tr_([ Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Name") ]), Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Email") ]), Halogen_HTML_Elements.th_([ Halogen_HTML_Core.text("Phone") ]) ]) ]), Halogen_HTML_Elements.tbody_(Data_Functor.map(Data_Functor.functorArray)(renderRow)(state.contacts)) ]);
      };
      var handle = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Repo.findAll))(function (contactsEither) {
              ...
              if (contactsEither instanceof Data_Either.Right) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      ...
                      $7.contacts = contactsEither.value0;
                      return $7;
                  });
              };
              throw new Error("Failed pattern match at Components (line 48, column 11 - line 50, column 61): " + [ contactsEither.constructor.name ]);
          });
      };
...
(function($PS) {
  ...
  var render = function (state) {
      ...
      return Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.ul_(Data_Functor.map(Data_Functor.functorArray)(function (i) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(Components.contactTableComponent)(Data_Unit.unit)(body);
  }));
  ...
  var handleAction = function (v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Repo.findAll))(function (itemsEither) {
          ...
          throw new Error("Failed pattern match at Main (line 57, column 5 - line 59, column 103): " + [ itemsEither.constructor.name ]);
      });
  };
